  ...
  <div class="home">
    <div class="photo">
      <van-swipe :autoplay="3000" indicator-color="white">
        <van-swipe-item><img width="100%" height="300px" src="../../assets/images/1.jpeg" alt=""></van-swipe-item>
        <van-swipe-item><img width="100%" height="300px" src="../../assets/images/2.jpeg" alt=""></van-swipe-item>
